...
import {
  ...
  PinIcon,
  IframeContent,
} from "../components/timelineStyledComponents";
    ...
    if (id) {
      ...
      return (
        <IframeContent>
          ...
          ></iframe>
          <Links href={post.link} onClick={(e) => goToLink(e, post.link)}>
            {post.link}
          </Links>
        </IframeContent>
      );
            ...
            <li key={post.id} id={post.id}>
              {post["repostedBy"] ? (
                <RepostIcon>
                  ...
                  />
                  Re-posted by{" "}
                  {user.user.username === post.repostedBy.username
                    ? "you"
              ...
              <div className="oficialPost">
                <div className="postLeft">
                  <img
                    ...
                    onClick={() => saveOtherUserInfo(post)}
                  />
                  <Likes
                    post={post}
                ...
                <div className="postRight">
                  <SpaceBetween>
                    <Flex>
                      <UserName
                        id={post.user.id}
                        onClick={() => goToUserPosts(post.user.id)}
                      >
                        {post.user.username}
                      </UserName>
                      {pinLocation(post)}
                    ...
                    <ReactHashtag
                      renderHashtag={(hashtagValue) => (
                        <Hashtag
                          ...
                          onClick={() => sendToHashtag(hashtagValue)}
                        >
                          {hashtagValue}
                        </Hashtag>
                      )}
              ...
              <CommentContainer
                ...
                idComment={post.id}
                postComments={postComments}
                postId={post.repostId ? post.repostId : post.id}
